...
`)),q=({onClickCancel:a})=>t(P,{children:[e("input",{onClick:()=>a(),className:"input_choice",type:"radio",name:"isClicked",id:""}),e("div",{className:"choice_text",children:"Annuler le paiement"})]});let $;const B=r($||($=(e=>e)`
