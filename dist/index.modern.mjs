import{jsx as e,jsxs as t,Fragment as a}from"react/jsx-runtime";import i from"react";import n,{createGlobalStyle as o}from"styled-components";import r from"axios";let c;const l=o(c||(c=(e=>e)`
      .button {
...
`)),s="https://api.feexpay.me/api/static/feexpay_logo-h.png",d="https://api.feexpay.me/api/static/logo_mastercard.svg",m="https://api.feexpay.me/api/static/logo_visa.svg",p="https://api.feexpay.me/api/static/logo_mtn.svg",g="https://api.feexpay.me/api/static/logo_moov.svg",h="https://api.feexpay.me/api/static/Flag_of_Togo.svg.png",u="https://api.feexpay.me/api/static/Flag_of_Benin.svg.png",_="https://api.feexpay.me/api/static/Flag_of_Rwanda.svg.png",f="https://api.feexpay.me/api/static/CI.png",x="https://api.feexpay.me/api";function y(){return y=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var a=arguments[t];for(var i in a)Object.prototype.hasOwnProperty.call(a,i)&&(e[i]=a[i])}return e},y.apply(this,arguments)}function v(e,t){switch(t.type){case"CHANGE/OPERATOR":return y({},e,t.payload);case"CHANGE/NUMERO":let a="";switch(t.payload.country){case 1:return Number.isNaN(parseInt(t.payload.num_client))?y({},e,t.payload):(a=`229${t.payload.num_client}`,console.log(a),y({},e,{num_client_without_code:t.payload.num_client,num_client:a}));case 2:return a=`228${t.payload.num_client}`,console.log(a),y({},e,{num_client:a});case 3:return a=`225${t.payload.num_client}`,console.log(a),y({},e,{num_client:a});case 4:return a=`250${t.payload.num_client}`,console.log(a),y({},e,{num_client:a});default:return console.log("Le numero n'a pas été verifié"),console.log(t.payload),y({},e,t.payload)}case"CHANGE/NUMWITHOUTCODE":return console.log("Num Change whithout code"),y({},e,{num_client_without_code:t.payload.num_client_without_code});case"CHANGE/REQUESTMESSAGE":return y({},e,{paiement_request_verify_msg:t.payload.paiement_request_verify_msg,stopchargement:t.payload.stopchargement});case"CHANGE/REQUESTTOPAYINFO":return y({},e,{requesttopayinfo:y({},t.payload)});default:throw new Error("Message")}}let N={};const w=({children:t,montant:a,apiURL:n,token:o,id:r,callback:c})=>{N={price:a,apiURL:n,token:o,id:r,operator_name:"",num_client:"",num_client_without_code:"",paiement_request_verify_msg:"En attente du paiement.",stopchargement:!1,requesttopayinfo:{},name_marchand:"",callback:c};const[l,s]=i.useReducer(v,N),d=i.useMemo(()=>({state:l,dispatch:s}),[l,s]);return e(b.Provider,{value:d,children:t})},b=i.createContext({state:N,dispatch:()=>{}});console.log(N);const k=()=>i.useContext(b),E=({open_modal:i,feexVisisbleBtn:n})=>{const{state:o}=k();return t(a,{children:[e(l,{}),t("button",{onClick:()=>i(),className:"button",style:{display:n?"flex":"none"},children:[e("span",{className:"button_text",children:"PAYER"}),t("span",{children:[" ",o.price," XOF"]}),e("img",{src:s,alt:""})]})]})};let C;const S=o(C||(C=(e=>e)`
...
`)),P=({pay_func:i})=>{const{state:n}=k();return t(a,{children:[e(F,{}),t("div",{className:"button_container",children:[e("button",{onClick:()=>i(),className:"button_pay",children:t("span",{className:"button_text",children:["Payer ",n.price," XOF"]})}),t("div",{className:"secure_by_feexpay",children:[e("div",{className:"lock_line"}),e("div",{className:"img_lock_container",children:e("img",{className:"img_lock",src:"https://api.feexpay.me/api/static/svg/icons8-lock.svg",alt:"icon lock"})}),e("div",{className:"lock_text",children:"Sécurisé par FeexPay"})]})]})]})},V=({changeVisibleChargementFunc:n,changeVisibleChargementExitFunc:o})=>{const[c,l]=i.useState(!1),[s,d]=i.useState(""),[m,h]=i.useState(""),[u,_]=i.useState("");i.useState(!1),i.useState(!1);const[f,y]=i.useState(!1),[v,N]=i.useState(""),{state:w,dispatch:b}=k(),[E,C]=i.useState(!1),[S,A]=i.useState(!1);return i.useEffect(()=>{!function(){const e=new String(w.num_client),t=new String(w.operator_name);e.length>4&&t.length>0&&!0===E?(async()=>{n(),console.log(w),await r.post(`${x}/transactions/requesttopay/externe`,{phoneNumber:`${w.num_client}`,amount:`${w.price}`,reseau:`${w.operator_name}`,token:`${w.token}`,id:`${w.id}`}).then(e=>{console.log(e);let t=0;const a=setInterval(async()=>{const i=await r.get(`${x}/transactions/getrequesttopay/externe/${e.data.reference}`),n=i.data.status;console.log(i.data),"SUCCESSFUL"===n&&(t+=1,t<2&&(clearInterval(a),console.log("Votre paiement à ete avec success"),b({type:"CHANGE/REQUESTTOPAYINFO",payload:{externalId:i.data.externalId,amount:i.data.amount,status:i.data.status,partyId:i.data.payer.partyId}}),b({type:"CHANGE/REQUESTMESSAGE",payload:{paiement_request_verify_msg:"Paiement effectué",stopchargement:!0}}),setTimeout(()=>{w.callback()},2e3))),"FAILED"===n&&(clearInterval(a),console.log("Verifier votre numero"),b({type:"CHANGE/REQUESTMESSAGE",payload:{paiement_request_verify_msg:"Veuillez verifier votre numero",stopchargement:!0}}),setTimeout(()=>{o()},2e3))},5e3);setTimeout(async()=>{"PENDING"===(await r.get(`${x}/transactions/getrequesttopay/externe/${e.data.reference}`)).data.status&&(console.log("Vous n'avez pas accepter la requete"),b({type:"CHANGE/REQUESTMESSAGE",payload:{paiement_request_verify_msg:"Vous n'avez pas accepter la requete",stopchargement:!0}}),o()),clearInterval(a)},25e3),console.log("Send")}).catch(e=>{console.log("No Send"),console.log(e),"Token API invalid"===e.response.data.message&&b({type:"CHANGE/REQUESTMESSAGE",payload:{paiement_request_verify_msg:"Veuillez contacter l'administrateur du site.",stopchargement:!0}})}),console.log("Function Send")})():console.log("Not sendReaquest")}()},[w.operator_name,w.num_client,c]),t(a,{children:[e(j,{}),t("div",{className:"choice_operator_card",children:[e("div",{className:"choice_operator_text",children:"Opérateur mobile"}),t("div",{className:"choice_operator_img",children:[t("div",{className:"choice_mtn",children:[e("input",{type:"radio",name:"operator_name",id:"",onChange:()=>(h(""),d("MTN"),_("MTN"),void A(!0))}),e("img",{className:"img_mtn",src:p,alt:"mtn"})]}),t("div",{className:"choice_moov",children:[e("input",{type:"radio",name:"operator_name",id:"",onChange:()=>(h("MOOV"),d(""),_("MOOV"),void A(!0))}),e("img",{className:"img_moov",src:g,alt:"moov"})]})]})]}),e("div",{className:"error_text_operator",style:{display:f?"block":"none"},children:v}),e(M,{send_pay_form:c,setnum_exist_true:()=>{C(!0)},setnum_exist_false:()=>{C(!1)}}),e(P,{pay_func:()=>(!1===c&&l(!0),!0===c&&l(!1),void(""===u?(y(!0),N("Choisissez un operateur mobile"),b({type:"CHANGE/OPERATOR",payload:{operator_name:""}})):(y(!1),N(""),b({type:"CHANGE/OPERATOR",payload:{operator_name:u}}))))})]})};let H;const U=n.div(H||(H=(e=>e)`
     transition:all 1s;
     border:solid 1.5px gray;
     display:flex;
     flex-direction:row;
...
`)),$=({onClickCancel:a})=>t(U,{children:[e("input",{onClick:()=>a(),className:"input_choice",type:"radio",name:"isClicked",id:""}),e("div",{className:"choice_text",children:"Annuler le paiement"})]});let L;const D=o(L||(L=(e=>e)`
...
`)),J=({isVisible:n})=>{const{state:o,dispatch:r}=k(),[c,l]=i.useState(!1);return i.useEffect(()=>{!0===n&&(l(!0),r({type:"CHANGE/REQUESTMESSAGE",payload:{paiement_request_verify_msg:"En attente du paiement.",stopchargement:!1}})),!1===n&&l(!1)},[n]),t(a,{children:[e(X,{}),e("div",{className:"chargement_container",style:{display:c?"flex":"none"},children:t("div",{className:"message_container",style:{backgroundColor:"Paiement effectué"===o.paiement_request_verify_msg?"green":"#D45D00"},children:[e("div",{className:"loader",style:{display:o.stopchargement?"none":"block"}}),e("div",{className:"request_msg",children:o.paiement_request_verify_msg})]})})]})},W=({isOpen:n,cancel_modal:o,cancel_modal_func:r,name_marchand:c})=>{const[l,d]=i.useState(!0),[m,p]=i.useState(!1),[g,h]=i.useState(!1),[u,_]=i.useState(!1),{state:f}=k();return t(a,{children:[e(S,{}),e(J,{isVisible:u}),e("div",{className:"modal_container",style:{position:"fixed !important",zIndex:"10000000000 !important",transition:"all 2s",transform:n&&!1===o?"scale(1)":"scale(0.6)",display:n&&!1===o?"flex":"none"},children:t("div",{className:"modal",children:[t("div",{className:"padding_add",style:{padding:"2rem",height:"94%"},children:[t("div",{className:"modal_header",children:[e("div",{className:"logo_container",children:e("img",{className:"logo",src:s,alt:"feexpay"})}),t("div",{className:"header_text",children:[t("div",{className:"marchant_name",children:["MARCHAND : ",c]}),"  ",t("div",{className:"id_info",children:[" ID : ",f.id]})]})]}),l&&t(a,{children:[e("div",{className:"pay_with",children:"PAYER AVEC :"}),e(R,{choice_local_func:()=>(p(!1),d(!1),void h(!0))}),e(T,{choice_cardBank_func:()=>(p(!0),d(!1),void h(!1))}),e($,{onClickCancel:()=>r()})]}),m&&e(Q,{}),g&&e(V,{changeVisibleChargementFunc:()=>{_(!0),console.log("Chargement Visible")},changeVisibleChargementExitFunc:()=>_(!1)})]}),e("div",{className:"footer_modal_container",children:e("div",{className:"footer_modal"})})]})})]})};let K;const Z=n.div(K||(K=(e=>e)`
...
`)),ee=({montant:n,token:o,id:c,callback:l})=>{const[s,d]=i.useState(!1),[m,p]=i.useState(!0),[g,h]=i.useState(!1),[u,_]=i.useState(""),f=n;return i.useEffect(()=>{!async function(){await r.get(`${x}/shop/${c}/get_shop`).then(e=>{_(e.data.name),h(!0)}).catch(e=>{"Le format de l'id est"===e.response.data.message&&(_(""),h(!1))})}()},[]),e(a,{children:t(w,{montant:f,token:o,id:c,callback:l,children:[e(Z,{children:e(W,{isOpen:s,cancel_modal:m,cancel_modal_func:()=>(console.log("cancel_modal"),d(!1),void p(!0)),name_marchand:u})}),e(E,{open_modal:()=>(console.log("open_modal"),d(!0),void p(!1)),feexVisisbleBtn:g})]})})};export{ee as default};
