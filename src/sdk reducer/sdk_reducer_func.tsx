...
export function reducer(state: any, action: any) {
  switch (action.type) {
      ...
      switch (action.payload.country) {
        case 1:
          if ( Number.isNaN(parseInt(action.payload.num_client))) {
            ...
            return { ...state,num_client_without_code:action.payload.num_client,num_client:num_client_state };
          }
        ...
        default:
          console.log("Le numero n'a pas été verifié");
    ...
    case "CHANGE/NUMWITHOUTCODE":
      console.log("Num Change whithout code");
      
      return {...state,num_client_without_code:action.payload.num_client_without_code};
      break;

    case "CHANGE/REQUESTMESSAGE" :
        return {...state,paiement_request_verify_msg:action.payload.paiement_request_verify_msg,stopchargement:action.payload.stopchargement}
      break;
