              ...
              <div className="pt-4">
                ...
                {paymentResult && (
                  <div className="mt-4 p-4 bg-gray-100 rounded-md">
                    <h3 className="font-bold text-lg mb-2">Payment Result:</h3>
                    <p><span className="font-medium">Reference:</span> {paymentResult.reference}</p>
                    <p>
                      <span className="font-medium">Status:</span> 
                      <span className={`ml-1 ${paymentResult.status === 'SUCCESSFUL' ? 'text-green-600' : 'text-red-600'}`}>
